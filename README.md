...
- run an update to install missing packages: 'poetry update'
...
'''
curl -X POST http://localhost:5000/startConversation -H "Content-Type: application/json" -d '{ "language": "en", "client": "discord", "userid": 123477}'
'''

Test how the conversations continues:
'''
curl -X POST http://localhost:5000/reply -H "Content-Type: application/json" -d '{ "language": "en", "client": "discord", "userid": 123477, "message": "I have no specific strategies. I use to summarise things I have to learn. I also like mindmaps. Sometimes I am learning for 20 Minutes and make a break afterwards bevore I continue to learn. " }'
''''
